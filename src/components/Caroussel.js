      ...
      return (
            <section className="Caroussel">
                  ...
                  {pictures.length > 1 ? (
                        <>
                              <i
                                    className="fa-solid fa-chevron-left Caroussel__chevron-left"
                                    onClick={previousSlide}
                              ></i>
                              <i
                                    className="fa-solid fa-chevron-right Caroussel__chevron-right"
                                    onClick={nextSlide}
                              ></i>

                              <div className="Caroussel__pages">
                                    <span className="Caroussel__current">
                                          {currentPage}
                                    </span>
                                    /
                                    <span className="Caroussel__total">
                                          {pictures.length}
                                    </span>
                              </div>
                        </>
